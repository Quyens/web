...
if ($_POST['action'] == 'buy') {
    ...
    if ($isBuy) {
        ...
        sendTele(templateTeles($getUser['username']." thuê cron thành công (#" . $getdata['rate'] . ")"));
...
if ($_POST['action'] == 'edit') {
    ...
    sendTele(templateTeles($getUser['username']." chỉnh sửa cron (#" . $magd . ")"));
...
if ($_POST['action'] == 'stop') {
    ...
    sendTele(templateTeles($getUser['username']." tạm dừng cron (#" . $magd . ")"));
...
if ($_POST['action'] == 'active') {
    ...
    sendTele(templateTeles($getUser['username']." kích hoạt cron (#" . $magd . ")"));
...
if ($_POST['action'] == 'giahan') {
    ...
    if ($isBuy) {
        ...
        $TN->insert("logs", [
         ...
         sendTele(templateTeles($getUser['username']." gia hạn cron (#" . $magd . ")"));
