...
{
    $row = $TN->get_row(" SELECT * FROM `usersda` WHERE `id` = '".check_string($_GET['id'])."'  ");
    if(!$row)
    {
...
if(isset($_POST['Save']) && $getUser['level'] == 1)
{
    ...
    $isInsert= $TN->update("usersda", array(
    ...
    <section class="content">
        <div class="row">
            <section class="col-lg-6">
                <div class="mb-3">
                    <a class="btn btn-danger btn-icon-left m-b-10" href="<?=BASE_URL('admin/ListUsers')?>"
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" value="<?=$row['money']?>"
                                    name="money" required>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="card-body">
                        <div class="table-responsive p-0">
                            <table id="datatable1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1; foreach($TN->get_list("SELECT * FROM `log_balance` WHERE `user_id`='".$row['id']."' ORDER BY `id` DESC") as $row){?>
                                    <tr>
                                        <td><?=$i++?></td>
                    ...
                    <div class="card-body">
                        <div class="table-responsive p-0">
                            <table id="datatable2" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php $i=1; foreach($TN->get_list("SELECT * FROM `logs` WHERE `user_id`='".$row['id']."' ORDER BY `id` DESC") as $row){?>
                                    <tr>
                                        <td><?=$i++?></td>
