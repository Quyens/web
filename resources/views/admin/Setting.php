                        ...
                        <div class="card-header p-0 pt-1 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-three-google-tab" data-toggle="pill" href="#tab4" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="false">GOOGLE</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                           <div class="tab-content" id="custom-tabs-three-tabContent">
                                    ...
                                    <form action="" method="POST">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" name="status_momo">
                                                <option value="1" <?= $TN->site('status_momo') == '1' ? 'selected' : '' ?>>
                                                    Bật
                                                </option>
                                                <option value="0" <?= $TN->site('status_momo') == '0' ? 'selected' : '' ?>>
                                                    Tắt
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Token MOMO (<a type="button" data-toggle="modal" data-target="#modal-hd-auto-momo" href="#">Xem
                                                    hướng dẫn</a>)</label>
                                            <input type="text" class="form-control" name="token_momo" value="<?= $TN->site('token_momo') ?>" placeholder="Nhập token ví momo">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nội dung nạp</label>
                                            <input type="text" class="form-control" name="noidungnap_momo" value="<?= $TN->site('noidungnap_momo') ?>" placeholder="Nội dung nạp">
                                        </div>
                                        <button name="SaveSettings" class="btn btn-info btn-icon-left m-b-10" type="submit"><i class="fas fa-save mr-1"></i>Lưu Ngay</button>
                                    </form>
                                </div>
                                ...
                                <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4">
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">CLIENT ID (<a type="button" data-toggle="modal" data-target="#modal-hd-auto-momo" href="https://youtu.be/v3bME6_DTJk?si=LmdOlBMCvzcy_Cma">Xem
                                                    hướng dẫn</a>)</label>
                                            <input type="text" class="form-control" name="google_id" value="<?= $TN->site('google_id') ?>" placeholder="Nhập client id google ">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">CLIENT SECRET</label>
                                            <input type="text" class="form-control" name="google_secret" value="<?= $TN->site('google_secret') ?>" placeholder="Nhập client secret google ">
                                        </div>
                                        <button name="SaveSettings" class="btn btn-info btn-icon-left m-b-10" type="submit"><i class="fas fa-save mr-1"></i>Lưu Ngay</button>
                                    </form>
                                </div>
