                        ...
                        <div class="card-body">
                            <div class="table-responsive p-0">
                                <table id="datatable1" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php $i=0; foreach ($TN->get_list("SELECT * FROM `log_balance` WHERE `id` > 0 ORDER BY id DESC LIMIT 500 ") as $row) {?>
                                        <tr>
                        ...
                        <div class="card-body">
                            <div class="table-responsive p-0">
                                <table id="datatable2" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php $i=0; foreach ($TN->get_list("SELECT * FROM `logs` WHERE `id` > 0 ORDER BY id DESC LIMIT 500 ") as $row) {?>
                                        <tr>
                                            <td><?=$i++;?></td>
                                            <td class="text-center"><a
                                                    href="<?=base_url('admin/user-edit/'.$row['user_id']);?>"><?=getUser($row['user_id'], 'username');?></a>
