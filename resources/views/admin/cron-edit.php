...
$title = 'Chỉnh Sửa Máy Chủ Cron | ' . $TN->site('title');
$body = [
...
{
    $row = $TN->get_row(" SELECT * FROM `server_cron_auto` WHERE `id` = '".check_string($_GET['id'])."'  ");
    if(!$row)
    {
...
{
    $isUpdate= $TN->update("server_cron_auto", array(
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="limit" class="form-control" value="<?=$row['limit']?>"
                                    placeholder="Nhập số lượt thuê giới hạn" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Đã Thuê</label>
                                <input type="number" class="form-control" value="<?=$row['count']?>" name="count"
                                    placeholder="Đã thuê" readonly>
                            </div>
                            <div class="form-group">
