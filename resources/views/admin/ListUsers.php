                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?=format_cash($TN->num_rows("SELECT * FROM `usersda`"))?>
                                thành viên</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span
                                class="info-box-number"><?=format_cash($TN->get_row("SELECT SUM(`money`) FROM `usersda` ")['SUM(`money`)']);?>đ</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">Admin:
                                <?=format_cash($TN->num_rows("SELECT * FROM `usersda` WHERE `level`='admin'"))?></span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <?=format_cash($TN->num_rows("SELECT * FROM `usersda` WHERE `banned`='1'"))?> tài
                                khoản</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive p-0">
                                <table id="datatable1" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php $i=0; foreach ($TN->get_list("SELECT * FROM `usersda` ORDER BY `id` DESC") as $row) {?>
                                        <tr>
                                            <td><?=$i++?></td>
                                            <td>
                                                <ul>
