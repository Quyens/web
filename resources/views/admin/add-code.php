                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control"
                                    name="price" placeholder="Nhập giá bán" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Giá Gốc</label>
                                <input type="number" class="form-control"
                                    name="price_goc" placeholder="Nhập giá gốc" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    name="link_demo" placeholder="Nhập link demo" required>
                            </div>
                            <div class="form-group">
