...
if (isset($_COOKIE["token"])) {
    $getUser = $TN->get_row(" SELECT * FROM `usersda` WHERE `token` = '".check_string($_COOKIE['token'])."' ");
    if (!$getUser) {
...
if (!isset($_SESSION['login'])) {
    ...
    $getUser = $TN->get_row(" SELECT * FROM `usersda` WHERE `token` = '".check_string($_SESSION['login'])."'  ");
